...
::::: columns
::: {.column width="50%"}
The SHAP summary plot gives us a global overview of feature importance and effect.

-   Y-axis: Features, ranked by importance.

-   X-axis: The SHAP value.
...
::: {.column width="50%"}
```{r}
# PLACEHOLDER dor LASSO model SHAP values
```
:::
:::::
...
::::: columns
::: {.column width="50%"}
**Systolic Blood Pressure** ('med_sbp_mean') is the most important feature.

-   Low SBP (blue dots) have positive SHAP values, meaning they push the prediction towards becoming a centenarian.

-   High SBP (red dots) have negative SHAP values, pushing the prediction away from it.

**Smoking Status** ('med_smoke_status\_@_never') is also important.

-   Being a never-smoker (red dot, since it's a dummy variable) has a positive SHAP value, increasing the chance of being a centenarian.
:::
...
Here we see a clear negative relationship: as systolic blood pressure increases, its SHAP value decreases, lowering the predicted probability of becoming a centenarian.
