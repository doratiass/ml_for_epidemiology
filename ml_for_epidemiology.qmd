...
**Bias**: systematic wrongness. measures how far off, on average, a model’s predictions are from the ground truth values.

**Variance**: instability. measures how much a model’s predictions change with different training datasets
