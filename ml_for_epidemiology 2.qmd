...
plot_ly(
  ...
  colors = c(
    "Max Entropy" = "#FF6B6B",
    #"Random Search" = "#4ECDC4",
    "Latin Hypercube" = "#4ECDC4"
  ),
  ...
  layout(
    scene = list(
      xaxis = list(title = "log₁₀(λ) - L2 Regularization"),
      yaxis = list(title = "d - Max Depth"),
      zaxis = list(title = "log₁₀(η) - Learning Rate")
    ),
